                                ...
                                <table class="table mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <!-- View Button -->
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#viewModal{{ $project->id }}">
                                                    View
                                                </button>

                                                <!-- Update Button -->
                                                <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#updateModal{{ $project->id }}">
                                                    Update
                                                </button>
